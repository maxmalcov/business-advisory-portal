...
const ScheduleSection: React.FC<ScheduleSectionProps> = ({ employee }) => {
  const hasSchedule = employee.weeklySchedule && employee.weeklySchedule.trim().length > 0;
  ...
  return (
    <div className="space-y-2">
      ...
      {hasSchedule ? (
        ...
        <div className="text-sm text-gray-500 italic">No schedule information available</div>
      )}
    </div>
  );
};
