  ...
  return (
    <div className="space-y-2">
      <h3 className="text-sm font-medium text-gray-500">
        {t('hr.index.employee.detail-from.schedule')}
      </h3>
        ...
        <CardContent className="pt-4">
          <div className="space-y-2">
            <div className="flex items-start justify-between">
              <Label htmlFor="weeklySchedule" className="text-base">
                {t('hr.index.employee.detail-from.weekly')}
              </Label>
            ...
            <div className="text-xs text-gray-500 mt-1">
              ...
              <ul className="list-disc list-inside space-y-1 mt-1">
                <li>
                  {t('hr.index.employee.detail-from.schedule.examples.1')}
                </li>
                <li>
                  {t('hr.index.employee.detail-from.schedule.examples.2')}
                </li>
                <li>
                  {t('hr.index.employee.detail-from.schedule.examples.3')}
                </li>
              </ul>
            </div>
          </div>
