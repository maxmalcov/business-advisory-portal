  ...
  const getMessages = () => {
    if (language === 'es') {
      return {
        ...
        searchMessage: 'No se encontraron facturas que coincidan con sus criterios de búsqueda.',
        filterMessage: (type: string) => `No se encontraron facturas de ${type === 'sale' ? 'venta' : 'proveedores'}.`,
