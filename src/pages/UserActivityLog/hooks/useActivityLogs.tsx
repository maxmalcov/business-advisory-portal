...
export const useActivityLogs = ({ 
  ...
  const [paginatedActivities, setPaginatedActivities] = useState<ActivityEvent[]>([]);
    ...
    const fetchActivities = async () => {
      try {
        ...
        toast({
          ...
          description: "There was a problem loading your activity data. Please try again later.",
        });
      } finally {
        setLoading(false);
      }
  ...
  const filterActivities = useCallback((query: string) => {
    if (!query.trim()) {
