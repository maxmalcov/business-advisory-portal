...
const SubscriptionChartView: React.FC<SubscriptionChartViewProps> = ({ data, loading }) => {
  if (loading) {
    return (
      <Card>
        ...
        <div className="h-72 w-full">
          {data.length > 0 ? (
            ...
            <div className="h-full flex items-center justify-center">
              <p className="text-muted-foreground text-center">No subscription data available for the selected period.</p>
            </div>
          )}
        </div>
      </CardContent>
