    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      >
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {servicesStats.completed} {texts.completed}, {servicesStats.pending}{' '}
            {texts.pending}
          </p>
        </CardContent>
      </Card>
      ...
      >
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {subscriptionStats.active} {texts.active},{' '}
            {subscriptionStats.pending} {texts.pending}
          </p>
        </CardContent>
      </Card>
    </div>
