...
export const useServiceManagement = () => {
  const { services, setServices, loading, setLoading, handleDelete } = useServiceData();
  const { isDialogOpen, setIsDialogOpen, isEditMode, openAddDialog, openEditDialog, serviceForm } = useServiceDialog();
